...
import { submitAnamnesis } from '@/anamnesis/api-client'
import {
  EVOLUTION_OPTIONS,
  FIXED_CITY,
  formatLocalDateTime,
...
import {
  validateStep,
  type AnamnesisStep,
} from '@/anamnesis/validation'
import { PersonFields } from '@/components/anamnesis/PersonFields'
import { SelectWithOther } from '@/components/anamnesis/SelectWithOther'
